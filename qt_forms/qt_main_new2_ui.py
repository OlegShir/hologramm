...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(50, 20, 121, 16))
        self.label_4.setObjectName("label_4")
        self.label_7 = QtWidgets.QLabel(self.tab_3)
        self.label_7.setGeometry(QtCore.QRect(50, 100, 121, 16))
        ...
        self.Amp_characts = QtWidgets.QGroupBox(self.tab_2)
        self.Amp_characts.setEnabled(True)
        self.Amp_characts.setGeometry(QtCore.QRect(230, 10, 291, 231))
        self.Amp_characts.setObjectName("Amp_characts")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Изменение контраста"))
        self.label_7.setText(_translate("MainWindow", "Изменение яркости"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Обработка изображения"))
        ...
        self.Amp_characts.setTitle(_translate("MainWindow", "Амплитудные характеристики изображения"))
